...
export default function RegisterPage() {
  ...
  return (
    <>
      <div className="register-glow-card w-full max-w-md">
        <div className="relative z-10 p-8 space-y-4 bg-black rounded-[0.875rem] shadow-2xl text-center">
          ...
          <form onSubmit={handleRegister} className="space-y-4 text-left">
            ...
            <Button type="submit" className="w-full bg-sky-600 hover:bg-sky-700 text-white font-bold pt-2">
              Create Account
            </Button>
          </form>
          <div className="text-center">
            <p className="text-sm text-[hsl(215_20%_65%)]">
              ...
              <Link href="/login" className="font-medium bg-blue-600 text-white px-3 py-1 rounded-md hover:bg-blue-700 no-underline">
                Login
              </Link>
            </p>
          </div>
      ...
      <style jsx global>{`
        ...
        .register-glow-card::before {
          ...
          animation: glow-enter-blur 1s ease .5s forwards;
          opacity: 0;
        }
        ...
        .register-glow-card::after {
          ...
          animation: glow-enter-stroke 0.5s ease 0.5s forwards;
          opacity: 0.5;
        }

        /* Style for dropdown options */
        .custom-select option {
          background-color: #27272a; /* Corresponds to zinc-800 */
          color: white;
        }
      `}</style>
    </>
